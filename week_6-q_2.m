...
w = ( ( in_sample_data' * in_sample_data ) \ in_sample_data' ) * y_in ;
...
% euclidean distances
a = sqrt( (0.03 - e_in)^2 + (0.08 - e_out)^2 )
b = sqrt( (0.03 - e_in)^2 + (0.10 - e_out)^2 )
c = sqrt( (0.04 - e_in)^2 + (0.09 - e_out)^2 )
d = sqrt( (0.04 - e_in)^2 + (0.11 - e_out)^2 )
e = sqrt( (0.05 - e_in)^2 + (0.10 - e_out)^2 )
